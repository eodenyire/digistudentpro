"""
Django settings for DigiStudentPro project.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='digistudentpro'),
...
# Conditionally include static directory only if it exists
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@digistudentpro.co.ke')
...
# DigiStudentPro Specific Settings
DIGISTUDENTPRO_SETTINGS = {
    'MIN_AGE_WITHOUT_CONSENT': 18,
    'SESSION_TIMEOUT_MINUTES': 30,
    'MAX_UPLOAD_SIZE_MB': 50,
    'ALLOWED_RESOURCE_TYPES': ['text', 'video', 'audio', 'pdf', 'assessment'],
}
